...
# THIS CODE COME FROM BOUTIQUE ADO, IT WAS ADJUSTED TO ZERO-TV PROJECT
class UserProfileforms(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields:
            ...
            self.fields[field].widget.attrs['class'] = 'border-black rounded-0 profileS-fRom-input'
